...
namespace SFA.DAS.Payments.MatchedLearner.AcceptanceTests
{
    public class TestRepository
    {
        ...
        public async Task AddDataLockEvent(long ukprn, long uln)
        {
            ...
            INSERT INTO Payments2.Job (IlrSubmissionTime,   JobType, Status, DCJobId, Ukprn, AcademicYear, CollectionPeriod, DCJobSucceeded)
                               VALUES (SysDateTimeOffset(), 1,       2,       456,      @ukprn, 1920,          14,                 1)
            ...
            VALUES (@dataLockEventId1, NewID(), @ukprn, 1, 1, 2021, 'ref#', @uln, 'ZPROG001', 100, 200, 300, 400, 'funding', 
            ...
            INSERT INTO Payments2.DataLockEvent (EventId, EarningEventId, Ukprn, ContractType, CollectionPeriod, AcademicYear,
                ...
                LearningAimFrameworkCode, LearningAimPathwayCode, LearningAimFundingLineType, IlrSubmissionDateTime, IsPayable,
                DataLockSourceId, JobId, EventTime, LearningStartDate)
            VALUES (@dataLockEventId2, NewID(), @ukprn, 1, 14, 1920, 'ref#', @uln, 'ZPROG001', 100, 200, 300, 400, 'funding', 
                '2020-10-10', 0, 0, 456, SysDateTimeOffset(), '2020-10-09 0:00 +00:00')
            ...
            VALUES  (@dataLockEventId1, 'TEST', 1, 1, 100, 1, SysDateTimeOffset(), -123456),
                    (@dataLockEventId1, 'TEST', 1, 2, 200, 1, SysDateTimeOffset(), -123456),
                    (@dataLockEventId1, 'TEST', 1, 3, 300, 1, SysDateTimeOffset(), -123456)

            INSERT INTO Payments2.DataLockEventPayablePeriod (DataLockEventId, PriceEpisodeIdentifier, TransactionType, DeliveryPeriod,
                Amount, SfaContributionPercentage, LearningStartDate, ApprenticeshipId)
            VALUES  (@dataLockEventId2, 'TEST', 1, 1, 100, 1, SysDateTimeOffset(), -123456),
                    (@dataLockEventId2, 'TEST', 1, 2, 200, 1, SysDateTimeOffset(), -123456),
                    (@dataLockEventId2, 'TEST', 1, 3, 300, 1, SysDateTimeOffset(), -123456)
            ...
            VALUES  (@dataLockEventId1, @dataLockEventFailureId1, 'TEST', 1, 3, 400, 1),
                    (@dataLockEventId1, @dataLockEventFailureId2, 'TEST', 1, 4, 500, 1),
                    (@dataLockEventId1, @dataLockEventFailureId3, 'TEST', 1, 5, 600, 1),
                    (@dataLockEventId1, @dataLockEventFailureId4, 'TEST', 1, 6, 600, 1)
            ...
            INSERT INTO Payments2.DataLockEventPriceEpisode (DataLockEventId, PriceEpisodeIdentifier, SfaContributionPercentage,
                ...
                Completed)
            VALUES (@dataLockEventId1, 'TEST', 1, 1000, 2000, 0, 0, '2020-10-07', SysDateTimeOffset(), '2020-10-11', '2020-10-12', 12, 50, 550, 0)

            INSERT INTO Payments2.DataLockEventPriceEpisode (DataLockEventId, PriceEpisodeIdentifier, SfaContributionPercentage,
                TotalNegotiatedPrice1, TotalNegotiatedPrice2, TotalNegotiatedPrice3, TotalNegotiatedPrice4, StartDate,
                EffectiveTotalNegotiatedPriceStartDate, PlannedEndDate, ActualEndDate, NumberOfInstalments, InstalmentAmount, CompletionAmount,
                Completed)
            VALUES (@dataLockEventId2, 'TEST', 1, 1000, 2000, 0, 0, '2020-10-07', SysDateTimeOffset(), '2020-10-11', '2020-10-12', 12, 50, 550, 0)
            ";
            ...
            {
                ukprn, uln, dataLockEventId1, dataLockEventId2,
