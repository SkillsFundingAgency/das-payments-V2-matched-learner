...
Scenario: Function pulls the datalock events from Payments DB and saves Trainings to matched learner DB
...
Scenario: Existing Trainings data for current collection is deleted before saving new Trainings Data to matched learner DB
