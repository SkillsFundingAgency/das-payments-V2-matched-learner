...
CREATE NONCLUSTERED INDEX [IX_DataLockEventPayablePeriod__DataLockEventId] ON [Payments2].[DataLockEventPayablePeriod] ([DataLockEventId], [TransactionType], [PriceEpisodeIdentifier], [Amount], [DeliveryPeriod]) WITH (ONLINE = ON);