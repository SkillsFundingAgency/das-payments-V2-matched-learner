...
namespace SFA.DAS.Payments.MatchedLearner.Functions.Migration
{
    public class ProviderLevelMatchedLearnerMigration
    {
        ...
        public async Task RunProviderLevelMatchedLearnerMigration([ServiceBusTrigger("%ProviderLevelMatchedLearnerMigrationQueue%", Connection = "ServiceBusConnectionString")] string message)
        {
